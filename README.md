...
[![Sonarcloud Status](https://sonarcloud.io/api/project_badges/measure?project=org.joinfaces:joinfaces-example&metric=alert_status)](https://sonarcloud.io/dashboard?id=joinfaces_joinfaces-maven-jar-example)
