...
[![Build Status](https://github.com/joinfaces/joinfaces-maven-jar-example/actions/workflows/maven.yml/badge.svg)
...
3- Run
```Shell
java -jar target/joinfaces-example-4.5.0-rc1.jar
```
...
```xml
<properties>
   <joinfaces.version>4.5.0-rc1</joinfaces.version>
</properties>
