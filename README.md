...
[![Codecov](https://codecov.io/gh/joinfaces/joinfaces-maven-jar-example/branch/6.1.x/graph/badge.svg)](https://codecov.io/gh/joinfaces/joinfaces-maven-jar-example)
...
3- Run
```Shell
java -jar target/joinfaces-example-6.1.x.jar
```
